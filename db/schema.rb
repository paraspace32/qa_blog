...
ActiveRecord::Schema.define(version: 20170511133625) do
  ...
  create_table "ques_cats", force: :cascade do |t|
    t.integer  "question_id", limit: 4
    t.integer  "category_id", limit: 4
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
  ...
  create_table "questions_categories_joins", force: :cascade do |t|
    t.integer "question_id", limit: 4
    t.integer "category_id", limit: 4
  end
